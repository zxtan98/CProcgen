...
void LeaperContextOption::parse_options(VecOptions *opts) {
    ...
    opts->consume_int("num_road_lanes", &num_road_lanes, true, 2);
    opts->consume_int("num_log_lanes", &num_log_lanes, true, 2);
...
void LeaperContextOption::copy_options(LeaperContextOption *opts) {
    ...
    num_road_lanes = opts->num_road_lanes;
    num_log_lanes = opts->num_log_lanes;
