...
void BossfightContextOption::parse_options(VecOptions *opts) {
    ...
    opts->consume_int("invulnerable_time", &invulnerable_time, true, 2);
    ...
    opts->consume_int("rounds_num", &rounds_num, true, 3);
    opts->consume_int("round_health", &round_health, true, 4);
    ...
    opts->consume_int("barrier_num", &barrier_num, true, 2);
...
void BossfightContextOption::copy_options(BossfightContextOption *opts){
    ...
    invulnerable_time = opts->invulnerable_time;
    ...
    rounds_num = opts->rounds_num;
    round_health = opts->round_health;
